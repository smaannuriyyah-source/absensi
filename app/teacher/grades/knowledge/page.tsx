...
export default function KnowledgeGradePage() {
  ...
  const handleSave = async (studentId: number) => {
    ...
    setSaving(true);
    try {
      const res = await fetch("/api/grades/knowledge", {
        method: "POST",
  ...
  const handleCancel = (studentId: number) => {
    setEditing((prev) => ({ ...prev, [studentId]: false }));
    loadGrades(); // Reset to original values
  };
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-100">Penilaian Pengetahuan</h2>
            ...
            <table className="min-w-full">
              <thead>
                <tr className="glass-table-header border-b border-white/20 dark:border-white/10">
                  ...
                  <th className="px-4 py-3.5 text-center text-sm font-semibold text-gray-700 dark:text-gray-300 w-20">UH 1</th>
                  <th className="px-4 py-3.5 text-center text-sm font-semibold text-gray-700 dark:text-gray-300 w-20">UH 2</th>
                  <th className="px-4 py-3.5 text-center text-sm font-semibold text-gray-700 dark:text-gray-300 w-20">UH 3</th>
                  <th className="px-4 py-3.5 text-center text-sm font-semibold text-gray-700 dark:text-gray-300 w-20">UTS</th>
                  <th className="px-4 py-3.5 text-center text-sm font-semibold text-gray-700 dark:text-gray-300 w-20">UAS</th>
                ...
                {students.map((student, index) => {
                  ...
                  return (
                    <tr key={student.id} className="glass-table-row border-b border-white/10 dark:border-white/5 last:border-b-0">
                      ...
                      {(["uh1", "uh2", "uh3", "uts", "uas"] as const).map(
                        (field) => (
